...
- V1.6（当前）：机器学习交易引擎（XGBoost 涨跌预测、LSTM 时间序列、Transformer 行情模型、特征工程、模型融合、模型仓库自动选择、AI 交易信号）
- V1.7（规划）：强化学习交易 Agent（Deep RL、PPO 交易 Agent、DQN 买卖决策、AI 模拟百万次交易、自动仓位管理、风险收益优化、自主交易习惯、AI 交易人格）
